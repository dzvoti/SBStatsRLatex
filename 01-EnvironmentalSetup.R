...
# Set your WD to ~/SBStatsLatex. Some things in the file will not work if working directory is not set to this. Use <Ctrl+Shift+H> then choose the directory you unziped to. Check that the WD was set correctly by running <getwd()> as below.
getwd()
 
 
# 2. Check your environment ----
# Check the packages that you have installed.The command below will allow you to view all your installed packages ineractively and query them. We require tinytex,Knitr and renv. Do not worry if these are not present in you directory we will 'install' them next.
